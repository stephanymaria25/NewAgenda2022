  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">José Hermeson</a>
        </div>
      </div>
          ...
          <div class="col-md-7">
            <div class="card card-primary">
              <div style="text-align: center;" class="card-body p-0">
               <img style="margin-top:50px; width:200px; border-radius:100%" src="img/contato/Neymar Jr wallpaper by ZackAX - Download on ZEDGE™ cf7f.jpeg"> 
              <h1>Neymar Jr</h1>
              <h1>(37) 99911-0400</h1>
              <h1>adultoney@gmail.com</h1>
            </div>
              <!-- /.card-body -->
            </div>
          </div>
